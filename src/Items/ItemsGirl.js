...
function ItemsBoy({ girlItems }) {
  return (
    <div className="row" id="item-boy">
      {girlItems.map((girls) => (
        <div className="col-6 col-md-4 col-lg-3" key={girls.id}>
          <div className="item-box">
            <Link to={"/girls/" + girls.slug}>
              <img src={girls.image} alt={"ảnh sản phẩm " + girls.name} />
            </Link>
            <div id="item-mask" />
            <Link to={"/girls/" + girls.slug}>
          ...
          <div className="item-info">
            <div className="item-info1">
              ...
              <div className="item-price">
                <span>{girls.priceNew} VNĐ</span>{" "}
                <span className="span-off">| - {girls.percent}</span>
              </div>
            </div>
